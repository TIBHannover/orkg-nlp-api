...
from app.models.feedback import FeedbackCreateRequest, FeedbackCreateResponse, FeedbackReadAllResponse
...
def creates_feedback(request: FeedbackCreateRequest, db: Session = Depends(get_db)):
    ...
    return feedback_service.create(request.feedback.service_name, request.feedback.request, request.feedback.response)
