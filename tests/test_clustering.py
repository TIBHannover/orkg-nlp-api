...
from tests.mock.mock_clustering import (
    BioAssaysSemantifierMock,
    PredicatesRecommenderMock,
)

app.dependency_overrides[
    BioassaysService.get_semantifier
] = BioAssaysSemantifierMock.get_semantifier
app.dependency_overrides[
    PredicatesService.get_recommender
] = PredicatesRecommenderMock.get_recommender
client = TestClient(app)


def test_recommends_predicates():
    response = client.post(
        "/clustering/predicates", json={"title": "title", "abstract": "abstract"}
    )
